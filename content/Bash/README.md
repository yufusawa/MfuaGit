# Bash скрипты для начинающих для студентов
...
**1971** - Кен Томпсон создал первый Unix shell (Thompson shell) в Bell Labs:
- Очень простой
- Базовые возможности: запуск программ, перенаправление ввода/вывода
- Не поддерживал скрипты

**1977** - Стивен Борн создал Bourne shell (sh):
...
**1989** - Брайан Фокс создает Bash (Bourne Again SHell):
...
```
Шебанг — в > программировании последовательность из символов решётки и восклицательного знака в начале файла скрипта.
```
