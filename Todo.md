...
- Markdown + Bash (+ cредства диагностики  и работы в Linux) + Git - выполнили Bash и Linux. Other/MyNotes/README.md.  Довольно подробно прошли git, кроме слияния веток.
