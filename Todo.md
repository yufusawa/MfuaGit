...
- Студентам - выбрать себе 2-3 соразработчиков совместного проетка, назначить тимлида (главного). Тимлид создаёт публичный репозиторий с README.md и приглашает соразработчиков для совместного кодинга.
