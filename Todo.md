...
Тема занятия: Git - командная работа
Студентам выполнить:
- Синхронизировать мой с вашим репозитории
- Проверить, проходили ли они со мной файловые операции Bash
- Студентам - выбрать себе 2-3 соразработчиков совместного проетка, назначить главного. Главный создаёт публичный репозиторий с README.md и приглашает своих соразработчиков для совместного кодинга.
